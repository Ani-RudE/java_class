...
class iteratorDemo {
     public static void main(String[] args) {
          ...
          // "iterator()"" is a built in method, it will return the base address of the
          // first element in the object "a1" to the LHS element "itr"

          while (itr.hasNext()) // The "hasNext()" will return TRUE till we reach the last element
          // The last element in the list is "null", in which case the "hasNext()" will
          // return FASLE
          {
